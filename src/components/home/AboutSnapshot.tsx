...
const values = [
  ...
  },
  {
    ...
    title: "Speed",
    description:
      "Industry-leading turnaround from requirement to submission.",
      ...
      <Container className="relative">
        <ScrollReveal>
          <SectionHeading
            ...
            subtitle="Specialized in connecting US businesses with exceptional IT, Engineering, and Professional talent."
          />
        </ScrollReveal>
